export
  function isFslightbox() {
  let paddingBlocksRecompense = document.querySelectorAll('.js-scroll-padding');
  !
    function (e, t) {
        ...
        function w(e) {
          ...
          this.getSourceTypeFromLocalStorageByUrl = function (e) {
            ...
            this.handleReceivedSourceTypeForUrl = function (e, n) {
              !1 === r[n] && (o--, "invalid" !== e ? r[n] = e : delete r[n], 0 === o && (!
                function (e, t) {
        ...
        function G(e) {
          ...
          this.runPositiveSwipedXActions = function () {
            ...
            this.runNegativeSwipedXActions = function () {
              void 0 === r.next || (i("negative"), n.changeTo(r.next)),
                i("zero")
            };
          var i = function (e) {
          ...
          n = (t = e).core.classFacade,
              ...
              function o() {
                ...
                if (document.body.offsetHeight > innerHeight) {
                  document.body.style.marginRight = t.scrollbarWidth + "px",
                    ...
                    paddingBlocksRecompense.forEach((item) => {
                      item.style.paddingRight = t.scrollbarWidth + "px";
                    })
                }
              }
            ...
            function (e) {
              ...
              r.runActions = function () {
                ...
                for (var e = 0; e < c.sources.length; e++) U(s[e], u),
